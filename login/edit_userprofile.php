                   ...
                   if(!preg_match('/^01[0-9]-\d{7,8}$/',$_POST['contact'])){
                    ...
                    // check Image requirements   
                       if(isset($_FILES['image'])){
                        ...
                        $sql1= "UPDATE user_form SET image='$pic', fname='{$_POST['first']}', lname='{$_POST['last']}', email='{$_POST['email']}', contact_num='{$_POST['contact']}' WHERE user_name = '{$_SESSION['user_name']}';";
			...
			if(mysqli_query($con,$sql1))
			{
				?>
					<script type="text/javascript">
						...
						window.location="edit_userprofile.php";
					</script>
				<?php
			}
		}
